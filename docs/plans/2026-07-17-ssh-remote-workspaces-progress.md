...
| AC-10 | Unknown/offline keeps same termination ID; terminal observation clears retained state, not operation success         | coordinator + retained inventory / 5           | Main remote lifecycle; retained inventory; runtime operation ledger                             | lifecycle/reconciler/store tests and disconnect integration           | passed |
