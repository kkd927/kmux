...
const unitSuites = [
  ...
  "apps/desktop/src/main/linuxSingleInstance.test.ts",
  "apps/desktop/src/main/linuxUpdateTiming.test.ts",
  "apps/desktop/src/main/pendingUpdate.test.ts",
  "apps/desktop/src/main/shutdownTasks.test.ts",
  "apps/desktop/src/main/updateInstallWatchdog.test.ts",
  ...
  "scripts/package-linux.test.mjs",
