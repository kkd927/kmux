...
const GIT_METADATA_TEST_TIMEOUT_MS = 15_000;

describe("metadata git branch resolution", () => {
  it(
    "bypasses the cwd cache when explicitly requested",
    async () => {
    ...
    GIT_METADATA_TEST_TIMEOUT_MS
  );

  it(
    "resolves the real gitdir and worktree root from a linked worktree",
    async () => {
